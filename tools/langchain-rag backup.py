...
prompt_template = ChatPromptTemplate.from_messages([
    ...
    Guidlines for the query:
        ...
        - if the question asks for a count, ALWAYS use COUNT(*)
...
system_message = prompt_template.format(dialect=db.dialect, table_info=db.get_table_info(), top_k=50)
...
agent = create_react_agent(llm, tools, prompt=system, checkpointer=memory)
    ...
    async for event in agent.astream_events(
        ...
        try:
            ...
            #     print("\nAnswer:")
                ...
                if(event['name'] == "search_proper_nouns"):
                    print("Vector DB Tools: Searching...")
                elif (event['name'] == "sql_db_query_checker"):
                    print("Query Checker Tools: Checking SQL Query...")
                elif(event['name'] == "sql_db_query"):
...
question1 = "Jelaskan trend penjualan Adidas di 2024 setiap Quartilnya"
# question2 = "Berapa penjualanku di Q4 2024"      
        
asyncio.run(run_agent(question1))
# asyncio.run(run_agent(question2))